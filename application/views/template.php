...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview <?= $this->uri->segment(1) == 'category' || $this->uri->segment(1) == 'unit' || $this->uri->segment(1) == 'item' ? 'active' : '' ?>">
                        ...
                        <ul class="treeview-menu">
                            <li <?= $this->uri->segment(1) == 'category' ? 'class="active"' : '' ?>><a href="<?= site_url('category') ?>"><i class="fa fa-circle-o"></i> Catagories</a></li>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2014-2016 <a href="#">BlanjaYuk</a>.</strong> All rights
            reserved.
        </footer>
    </div>
