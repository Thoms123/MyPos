                    ...
                    foreach ($row as $key => $data) { ?>
                        <tr>
                            ...
                            <td class="text-center" width="160px">
                                <a class="btn btn-default btn-xs" id="set_detail" data-toggle="modal" data-target="#modal-detail" data-barcode="<?= $data->barcode ?>" data-itemname="<?= $data->item_name ?>" data-detail="<?= $data->detail ?>" data-suppliername="<?= $data->supplier_name ?>" data-qty="<?= $data->qty ?>" data-date="<?= indo_date($data->date) ?>">
